...
#Arguements are the values passed to a function during function calling

# # Write a function to check whether a person is eligible for loan or not based on his income and credit score 
# def loan_eligibility(income, credit_score):
#     if income > 0 and 0 < credit_score <= 900:
#         if income > 500000 and credit_score >= 800:
